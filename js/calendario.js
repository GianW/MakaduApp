...
function selectMonth()
{
	...
	for(var no=0;no<monthArray.length;no++){
		document.getElementById('monthDiv_'+no).style.color='#CCC';	
	}
...
function selectHour()
{
	...
	if(activeSelectBoxHour){
		activeSelectBoxHour.style.color='#CCC';
	}
...
function selectMinute()
{
	...
	if(activeSelectBoxMinute){
		activeSelectBoxMinute.style.color='#CCC';
	}
...
function selectYear()
{
	...
	if(activeSelectBoxYear){
		activeSelectBoxYear.style.color='#CCC';
	}
...
function updateMonthDiv()
{
	...
	document.getElementById('monthDiv_' + currentMonth).style.color = '#CCC';
...
function updateMinuteDiv()
{
	for(no=0;no<60;no+=intervalSelectBox_minutes){
		...
		document.getElementById('minuteDiv_' + prefix + no).style.color = '#CCC';
	}	
	if(document.getElementById('minuteDiv_' + currentMinute)){	
		document.getElementById('minuteDiv_' + currentMinute).style.color = '#CCC';
